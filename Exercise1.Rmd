...
```
# ´´'{r} before the code and  ''' after the code refer to a code chunk. 
...
```
# new functions spec(), chunks, near()
...
# Filter works with these operators as well!  also remember the redirecting . in piping. 
